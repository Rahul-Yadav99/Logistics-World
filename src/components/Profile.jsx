      ...
      <div className="w-10/12 m-auto py-8">
        <div className="bg-white rounded shadow-lg p-8 border">
          ...
          <div className="grid grid-cols-3 gap-8">
            <div className="bg-white rounded mt-8 shadow-lg p-8 border col-span-2">
              <div className='flex gap-3'>
              ...
              <form className='grid grid-cols-2 gap-6' onSubmit={saveAddressInfo}>
            ...
            <div className="bg-white rounded mt-8 shadow-lg p-8 border">
              ...
              <h1 className="font-semibold text-lg mt-3">User Name: <span className="text-gray-600"></span></h1>
              <h1 className="font-semibold text-lg mt-3">User Email: <span className="text-gray-600"></span></h1>
            </div>
          </div>
        </div>
      </div>
