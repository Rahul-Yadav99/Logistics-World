  ...
  return (
    <Layout>
      <div className='w-6/12 m-auto py-8'>
        <h1 className='text-gray-600 text-3xl font-bold'> Booking</h1>
          ...
          <div className="">
            ...
            <form action="">
              <div className='mt-3'>
                ...
                <input type="text" name='pickuplocation' className='w-full p-2 mt-3 rounded border' />
              </div>
              ...
              <div className='mt-3'>
                ...
                <input type="text" name='destination' className='w-full p-2 mt-3 rounded border' />
              </div>
